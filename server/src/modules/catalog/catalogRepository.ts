...
class CatalogRepository {
  ...
  private buildFilterClause(
    ...
    const conditions: string[] = [pegiFilterClause()];
    const params: unknown[] = [hidePegi16, PEGI16_VALUES];
  ...
  async readByFilters(
    ...
    const { whereClause, params } = this.buildFilterClause(
      type,
      genreIds,
      hidePegi16,
    );
